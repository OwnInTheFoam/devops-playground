...
echo "[TASK] Remove headlamp manifest directory"
rm -rf ${HOME}/${K8S_CONTEXT}/projects/${CLUSTER_REPO}/infra/common/headlamp
...
sudo flux delete helmrelease headlamp

echo "[TASK] Delete the helm source"
sudo flux delete source helm headlamp

echo "[TASK] Delete namespace"
sudo kubectl delete namespace headlamp

echo "[TASK] Remove headlamp source"
rm -rf ${HOME}/${K8S_CONTEXT}/projects/${CLUSTER_REPO}/infra/common/sources/headlamp.yaml
