...
# DEFINES
SS_VER="2.11.0" #helm search hub --max-col-width 80 sealed-secrets | grep "bitnami-labs"
SS_BINARY_VER="0.23.0" #https://github.com/bitnami-labs/sealed-secrets/releases
CLUSTER_REPO=gitops
