...
# Gracefully shutdown bitcoin core
bitcoin-cli stop
#bitcoin-cli -rpcconnect=192.168.0.224 -rpcport=8332 -rpcuser=<REDACTED> -rpcpassword=<REDACTED> stop
# Wait for log
tail -f ~/.bitcoin/debug.log
# Relaunch
bitcoind -daemon
...
bitcoin-cli -testnet -rpcconnect=192.168.0.223 -rpcport=18332 -rpcuser=<REDACTED> -rpcpassword=<REDACTED> getblockchaininfo
```
